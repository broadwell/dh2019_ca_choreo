...
**Important:** here is [the original R Markdown version of this file](http://broadwell.github.io/DH2019_Movement_Choreography.Rmd), which you can download and open in RStudio, and here is [the raw .R format version](http://broadwell.github.io/DH2019_Movement_Choreography.R), if you prefer to use the basic R interpreter.
